...
type Employee struct {
	...
	PhoneNumber string       `json:"phone_number" gorm:"unique;size:15" validate:"required,max=15,numeric"`
	Direction   string       `json:"direction" gorm:"size:100" validate:"required,max=100"`
	BirthDate   time.Time    `json:"birth_date" gorm:"not null" validate:"required,datetime=2006-01-02"`
